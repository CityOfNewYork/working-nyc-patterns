...
module.exports = {
  ...
  'icons-ui': [
    "icon-wnyc-ui-menu.svg",
    "icon-wnyc-ui-alert-octagon.svg",
    "icon-wnyc-ui-navigation.svg",
    "icon-wnyc-ui-alert-triangle.svg",
    "icon-wnyc-ui-package.svg",
    "icon-wnyc-ui-arrow-left.svg",
    "icon-wnyc-ui-search.svg",
    "icon-wnyc-ui-arrow-right.svg",
    "icon-wnyc-ui-share-2.svg",
    "icon-wnyc-ui-award.svg",
    "icon-wnyc-ui-sliders.svg",
    "icon-wnyc-ui-bookmark.svg",
    "icon-wnyc-ui-translate.svg",
    "icon-wnyc-ui-calendar.svg",
    "icon-wnyc-ui-twitter.svg",
    "icon-wnyc-ui-check.svg",
    "icon-wnyc-ui-users.svg",
    "icon-wnyc-ui-chevron-down.svg",
    "icon-wnyc-ui-x.svg",
    "icon-wnyc-ui-chevron-left.svg",
    "icon-wnyc-ui-chevron-right.svg",
    "icon-wnyc-ui-chevron-up.svg",
    "icon-wnyc-ui-copy.svg",
    "icon-wnyc-ui-external-link.svg",
    "icon-wnyc-ui-facebook.svg",
    "icon-wnyc-ui-figma.svg",
    "icon-wnyc-ui-github.svg",
    "icon-wnyc-ui-hard-drive.svg",
    "icon-wnyc-ui-help.svg",
    "icon-wnyc-ui-info.svg"
  ],
  'buttons': {
    'inner-size': '1rem',
    'radius': '5px',
