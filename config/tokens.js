...
module.exports = {
  ...
  'icons-ui': [
    "icon-wnyc-ui-menu",
    "icon-wnyc-ui-alert-octagon",
    "icon-wnyc-ui-navigation",
    "icon-wnyc-ui-alert-triangle",
    "icon-wnyc-ui-package",
    "icon-wnyc-ui-arrow-left",
    "icon-wnyc-ui-search",
    "icon-wnyc-ui-arrow-right",
    "icon-wnyc-ui-share-2",
    "icon-wnyc-ui-award",
    "icon-wnyc-ui-sliders",
    "icon-wnyc-ui-bookmark",
    "icon-wnyc-ui-translate",
    "icon-wnyc-ui-calendar",
    "icon-wnyc-ui-twitter",
    "icon-wnyc-ui-check",
    "icon-wnyc-ui-users",
    "icon-wnyc-ui-chevron-down",
    "icon-wnyc-ui-x",
    "icon-wnyc-ui-chevron-left",
    "icon-wnyc-ui-chevron-right",
    "icon-wnyc-ui-chevron-up",
    "icon-wnyc-ui-copy",
    "icon-wnyc-ui-external-link",
    "icon-wnyc-ui-facebook",
    "icon-wnyc-ui-figma",
    "icon-wnyc-ui-github",
    "icon-wnyc-ui-hard-drive",
    "icon-wnyc-ui-help",
    "icon-wnyc-ui-info"
  ],
  'buttons': {
